  ...
  return (
    <AuthLayout>
      ...
      >
        ...
        <h1 className="text-4xl font-bold tracking-[-0.04em] text-[#172033]">
          Reset your password.
        </h1>
        <p className="text-base leading-7 text-[#667085]">
          Enter your registered operator email. We will send a time-limited verification code.
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="rounded-[1.75rem] border border-[#e2ebf2] bg-white p-7 shadow-[0_20px_60px_rgba(23,32,51,0.07)]"
      >
              ...
              <motion.div variants={fadeUp} className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border-2 py-3 pl-10 pr-4 text-sm text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 focus:ring-4
                          ${
            ...
            >
              ...
              <div className="flex w-full flex-col gap-3">
                ...
                <button
                  ...
                  className="text-sm font-medium text-slate-400 transition-colors hover:text-(--color-primary)"
                >
