 ...
 * --------------------------------------------------------------------------
 * Receives background pushes when the institution ERP tab is closed / unfocused.
...
const institutionName = params.get('institutionName') || 'Your institution';
const institutionLogoUrl = params.get('institutionLogoUrl') || '/favicon.ico';
