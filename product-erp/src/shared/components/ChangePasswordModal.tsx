          ...
          {requireCurrent && (
            <div>
              ...
              <input
                ...
                className={`${inputCls} ${formik.touched.currentPassword && formik.errors.currentPassword ? 'border-red-300 bg-red-50' : ''}`}
              />
              {formik.touched.currentPassword && formik.errors.currentPassword && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`${inputCls} pr-11 ${formik.touched.newPassword && formik.errors.newPassword ? 'border-red-300 bg-red-50' : ''}`}
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                aria-invalid={Boolean(formik.touched.confirm && formik.errors.confirm)}
                className={`${inputCls} pr-11 ${formik.touched.confirm && formik.errors.confirm ? 'border-red-300 bg-red-50' : ''}`}
              />
              <button
                type="button"
                aria-label={
