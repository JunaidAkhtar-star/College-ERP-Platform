  ...
  return (
    <AuthLayout>
      ...
      >
        ...
        <h2 className="text-3xl font-semibold tracking-tight text-slate-950">Set a new password</h2>
                    ...
                    <React.Fragment key={step}>
                      <div
                        className={`flex h-6 flex-1 items-center justify-center rounded-full text-[10px] font-bold transition-all duration-300
                            ${filled ? 'bg-(--color-primary) text-white' : 'bg-slate-100 text-slate-600'}`}
                      >
                        {step}
                      </div>
                      {i < 2 && (
                ...
                {!email && (
                  <motion.div variants={fadeUp} className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border-2 px-4 py-3 text-sm outline-none transition-all duration-200 placeholder:text-slate-600 focus:ring-4
                ...
                <motion.div variants={fadeUp} className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border-2 py-3 pl-10 pr-11 text-sm outline-none transition-all duration-200 placeholder:text-slate-600 focus:ring-4
